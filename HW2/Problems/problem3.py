...
'''
    ...
    In this problem, you will implement the Elo rating algorithm to rank players based upon match results (win/lose). Assuming all 
    the players' performance are random following a Logistic distribution with a scale of 400
...
#----------------------------------------------------
'''
    Given the current ratings of player A and player B, compute the expected probability of player A (with rating RA) to win in a game 
    against player B (with rating RB). 
    ---- Inputs: --------
...
'''
    ...
    ---- Inputs: --------
        ...
        * K: k-factor, a constant number which controls how maximum amount of change that can be applied on the rating of a player based 
            upon the result of one game.
    ---- Outputs: --------
