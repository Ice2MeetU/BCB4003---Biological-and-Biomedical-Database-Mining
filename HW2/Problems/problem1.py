...
#----------------------------------------------------
'''
    (Vote Page) In the third URL ('/vote/<ID>'), let's create a simple webpage for users to send data to the website host: 
    Each time when a user visits this page with a number (ID) in the URL (for example, /vote/10), return a webpage with 
    'Thank you for voting <ID>' (for example, 'Thank you for voting 10'). 
    ---- Inputs: --------
...
#----------------------------------------------------
'''
    (Template) create a jinja2 template that can be used to render 'Hello, <username>!' In this template, 
    we need to have a variable named 'username'. For example, if the username ='Alex', when rendering this template, 
    the returned string will be 'Hello, Alex!'; If the username = 'Bob', when rendering this template, the returned string will be 'Hello, Bob!'. 
    ---- Outputs: --------
