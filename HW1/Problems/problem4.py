...
def compute_players_BA(X6):
    ...
    X6.insert(loc = len(X6.columns), column = 'BA', value = X6['H']/X6['AB'] )
...
def rank_players_BA(X7):
    ...
    R1 = X7.sort_values(by = ['BA'], axis = 0, ascending = False)
...
def compute_players_OBP(X7):
    #########################################
    ## INSERT YOUR CODE HERE (4 points)
    X7.insert(loc = len(X7.columns), column = 'OBP', value = (X7['H'] + X7['BB'] + X7['HBP'])/( X7['AB'] + X7['BB'] + X7['HBP'] + X7['SF']))
...
def rank_players_OBP(X8):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    R2 = X8.sort_values(by = ['OBP'], axis = 0, ascending = False)
...
def compute_players_1B(X8):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X8.insert(loc = len(X8.columns), column = '1B', value = X8['H'] - X8['2B'] - X8['3B'] - X8['HR'])
...
def compute_players_TB(X9):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X9.insert(loc = len(X9.columns), column = 'TB', value = X9['1B'] + X9['2B']*2 + X9['3B']*3 + X9['HR']*4)
...
def compute_players_SLG(X10):
    #########################################
    ## INSERT YOUR CODE HERE (4 points)
    X10.insert(loc = len(X10.columns), column = 'SLG', value = X10['TB']/X10['AB'])
    #########################################
    #-----------------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
...
def rank_players_SLG(X11):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    R3 = X11.sort_values(by = ['SLG'], axis = 0, ascending = False)
