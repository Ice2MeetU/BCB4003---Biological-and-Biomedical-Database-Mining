...
'''
    ...
    ---- Inputs: --------
        * A: the adjacency matrix indicating the hyperlinks between webpages, a numpy matrix of shape (n X n). A[i][j] =1, 
            if there is a hyperlink from webpage j to webpage i; A[j][i]=0, if there is no hyperlink from webpage j to webpage i.
    ---- Outputs: --------
...
#----------------------------------------------------
'''
    Given the counts of in-links of each webpage and the dataframe storing all the webpages (X1), insert a new column (named 'Inlinks') 
    to the dataframe X1 to store the number of inlinks for each webpage. 
    ---- Inputs: --------
